...
<html xmlns="http://www.w3.org/1999/xhtml" version="-//W3C//DTD XHTML 1.1//EN" xml:lang="en">
	...
	<div id="loginform">
		...
		if ($ua && $ie && $ieVer < 7) {
			...
			<td><input type="text" class="text" class="form-control" name="HOST" value="<?php echo $host; ?>" /></td>
			</tr>
			<tr>
			<td class="field"><?php echo __("Username"); ?>:</td>
			<td><input type="text" class="text" class="form-control" name="USER" value="<?php echo $user; ?>" /></td>
			</tr>
			<tr>
			<td class="field"><?php echo __("Password"); ?>:</td>
			<td><input type="password" class="text" class="form-control" name="PASS" id="PASS" /></td>
			</tr>
			</table>
			<table cellpadding="0" id="LITEOPTIONS"<?php if ($adapter == "mysql") echo ' style="display: none"'; ?>>
			<tr>
			<td class="field"><?php echo __("Database"); ?>:</td>
			<td><input type="text" class="text" class="form-control" name="DATABASE" id="DATABASE" value="<?php echo $database; ?>" /></td>
			</tr>
			</table>
			<table cellpadding="0">
			<tr>
			<td class="field"></td>
			<td><input type="submit" class="btn btn-success" value="<?php echo __("Submit"); ?>" /></td>
			</tr>
			</table>
			<?php
