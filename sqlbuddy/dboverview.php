...
<?php
	...
	echo '<input type="submit" class="btn btn-success"" value="' . __("Submit") . '" />';
	echo '</td>';
	echo "</tr>";
...
<div class="inputbox">
	...
	<div id="fieldlist">
		...
		if ($conn->getAdapter() == "mysql") {
			...
			<td>
			<input type="text" class="text" class="form-control" name="NAME" onkeyup="updateFieldName(this)" />
			</td>
			...
			<td class="inputarea">
			<input type="text" class="text" class="form-control" name="VALUES" onkeyup="updateFieldName(this)" />
			</td>
			...
			<td class="inputarea">
			<input type="text" class="text" class="form-control" name="SIZE" onkeyup="updateFieldName(this)" />
			</td>
			<td class="secondaryheader" style="padding-left: 5px">
			<?php echo __("Key"); ?>:
			</td>
			<td class="inputarea">
			<select name="KEY" class="form-control" onchange="updateFieldName(this)">
			<option value=""></option>
			...
			<td class="inputarea">
			<input type="text" class="text" class="form-control" name="DEFAULT" onkeyup="updateFieldName(this)" />
			</td>
			<?php
