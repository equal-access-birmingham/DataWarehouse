...
define("MESSAGE_EMAIL_ALREADY_EXISTS", "This email address is already registered. Please visit the Admin Page if you need to reset the account.");
...
define("WORDING_REGISTRATION_CAPTCHA", "Please enter catcha phrase above");
