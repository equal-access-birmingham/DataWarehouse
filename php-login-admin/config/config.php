 ...
 */
define("DB_HOST", "192.168.4.254");
define("DB_NAME", "eablogindb");
define("DB_USER", "eablogindb");
define("DB_PASS", "sEYeKTALRZxGOhAYFOdxbf2yYuFoDY8H");
...
define("EMAIL_PASSWORDRESET_FROM", "your_username_email");
define("EMAIL_PASSWORDRESET_FROM_NAME", "yourname");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for EAB Intake Form");
 ...
 */
define("EMAIL_NEW_ACCOUNT_FROM", "your_username_email");
define("EMAIL_NEW_ACCOUNT_FROM_NAME", "yourname");
define("EMAIL_NEW_ACCOUNT_SUBJECT", "New Account for EAB Intake Form");
define("EMAIL_NEW_ACCOUNT_BODY", "You have been signed up for a new account at EAB Intake Form.  Below is your user name and temporary password, which will expire in 3 days.");

/**
 * Configuration for: account reset email
 * Much the same as registering, but this is for an outdated account
 */
define("EMAIL_RESET_ACCOUNT_FROM", "your_username_email");
define("EMAIL_RESET_ACCOUNT_FROM_NAME", "yourname");
define("EMAIL_RESET_ACCOUNT_SUBJECT", "Your Account with EAB Intake Form");
